...
#### Обратное ДП (уравнение Беллмана)
best_factor[T+1] ← 1.0
...
В ходе выполнения работы была успешно решена задача оптимального управления инвестиционным портфелем методом динамического программирования. Разработанный подход позволил определить стратегию, максимизирующую математическое ожидание конечного капитала. Полученные результаты подтверждают практическую ценность динамического программирования для решения многоэтапных финансовых задач и позволяют сформулировать обоснованные рекомендации по управлению портфелем в условиях неопределенности.

В целом, тема управления капиталом путем динамического программирования это правда интересно и круто. Наглядно видно, как рекуррентный расчёт по формуле Беллмана помогает принимать смарт решения в условиях неопределённости. Лаба была хоть и не простой, но полезной.